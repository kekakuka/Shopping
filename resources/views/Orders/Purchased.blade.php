...
@section('content')
    ...
    <div>
        <h4>The following is the  order's details.</h4>
        <dl class="dl-horizontal">
            ...
            <dd>{{Session::get('user')->EmailAddress}}</dd>
    ...
    <div><a class="btn btn-default col-xs-push-9 col-md-push-9 btn-lg" href="{{url('MemberSouvenirs')}}">More Souvenirs</a></div>
@endsection